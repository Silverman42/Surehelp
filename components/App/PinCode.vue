...
.vue-pincode-input-wrapper .vue-pincode-input.default {
  @apply border-[#DDE3EE] rounded-[12px] hover:border-primary-400 hover:ring-2 hover:ring-primary-50 focus:border-primary-400 focus:ring-4 focus:ring-primary-50;
  transition: all 0.3s;
}

.vue-pincode-input-wrapper .vue-pincode-input.default:not(:placeholder-shown) {
  @apply border-primary-400 ring-4 ring-primary-50;
  transition: all 0.3s;
}
